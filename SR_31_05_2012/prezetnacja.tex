...
\begin{frame}{Case study: Virtualized timers}
  ...
  \begin{itemize}
    ...
    \item Jest tylko parê (zwykle 3) na jednym procesorze.
  \end{itemize}
  Rozwi±zanie:
  \begin{itemize}
    \item Wirtualizacja zasobu:
    \begin{itemize}
      \item TinyOS dostarcza generyczny komponent zegar: TimerMilliC
      \item Mo¿emy mieæ wiele instacji jego i u¿ywaæ go jak zegara sprzêtowego.
      \item Jest Singleton, który kontrolujê dostêp do sprzêtu przez interfejs Alarm. 
    \end{itemize}
